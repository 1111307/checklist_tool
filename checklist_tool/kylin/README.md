...
| 类别 | 项数 | 项 |
|------|------|------|
| 自动判定 | 11 | 5.3-5.8、5.10、5.11、5.16、5.18、5.19（VLAN/路由/SSH/ACL/802.1x/端口隔离/组播/双机热备等设备命令回显类） |
| 部分信号 | 3 | 5.9 异构部署、5.22 存储网分离、5.23 配备合理性（脚本提取型号/存储网/端口闲置率，结论需台账比对） |
| 需人工 | 9 | 5.1、5.2、5.12-5.15、5.17、5.20、5.21（审批记录、方案文档、平台界面类） |
