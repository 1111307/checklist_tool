...
├── 配置核查作业指导书_v2.0.0.docx             核查标准依据（10 章、136 个编号检查项 + 第5章 13 张终端操作截图）
...
└── 配置核查工具操作说明书.docx             部署、运行与结果查看的逐步操作说明（含实际操作截图）
```

## 相关文档

- 《配置核查作业指导书》v2.0.0 —— 核查标准与操作方法（每节含判定标准与双平台核查步骤；与脚本、人工核查台、交叉验证报告标注的参考标准 v2.0.0 为同一版本，含第5章终端操作截图）
...
- 《配置核查工具操作说明书》—— 面向现场实施与运维人员：两个平台的部署、连接参数配置、一键运行、单组件运行、网络设备采集-解析、报告查看与汇总上报，含逐步操作截图与常见问题处理
