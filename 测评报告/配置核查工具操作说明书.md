...
![图 2　连接参数配置文件内容](说明书截图/op_win_conf.png)
...
![图 3　一键运行全部核查](说明书截图/op_win_runall.png)
...
![图 4　单独运行某个组件核查](说明书截图/run_win_mysql.png)
...
![图 5　网络设备核查的采集与解析](说明书截图/term_win_net.png)
...
![图 6　麒麟侧部署与授权](说明书截图/op_kylin_deploy.png)
...
![图 7　麒麟一键运行：组件探测与执行](说明书截图/op_kylin_detect.png)
...
![图 8　麒麟一键运行：执行完成与汇总](说明书截图/op_kylin_runall.png)
...
![图 9　麒麟单组件核查](说明书截图/run_kylin_mysql.png)
...
![图 10　Windows 侧报告输出清单](说明书截图/op_win_output.png)

> 执行 `dir /o-d /b output\*.html output\*.xls` 的实际输出。

![图 11　麒麟侧报告输出](说明书截图/op_kylin_output.png)
...
![图 12　核查报告样例（操作系统）](说明书截图/fig_win_os.png)
...
![图 13　人工核查台界面](说明书截图/fig_manual.png)
