...
FIG_NOTES = {
    ...
    'fig_summary_excel': 'Windows 版一键运行合并生成的汇总报告：表头标注组件数（8 个组件共 227 项），表体按组件列出全部检查项的判定、详情、修复建议与对应指导书章节，日常上报以此文件为准。',
...
FIG_GROUPS = [
    ...
    ('6.6 人工核查与汇总', None, [
        ...
        ('fig_summary_excel', '汇总报告 Excel 视图（8 个组件共 227 项，上报用）'),
