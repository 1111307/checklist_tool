...
A(f'| 需人工核查 | {n_manual} | {n_manual/total*100:.1f}% |')
A('')
A(f'其中工具可直接给出合格或不合格判定的检查项 {n_auto} 项；脚本已执行核查、并需结合台账或现场确认最终结论的 {n_part} 项，'
  f'两类合计 {n_auto+n_part} 项，占全部检查项的 {(n_auto+n_part)/total*100:.1f}%。'
